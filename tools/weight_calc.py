...
def get_w_fuel_0(w_profile, safety_factor):
    w_start_end = 1
    for w_i_j in w_profile:
        w_start_end *= w_i_j
...
def get_mtow(w_payload, w_profile, w_empty_0_init, safety_factor, max_iters=10):
    mtow_prev = 0
    ...
    w_fuel_0 = get_w_fuel_0(w_profile, safety_factor)
